...
export default async function RootLayout({ children, }: Readonly<{
 ...
 if (token) {
  ...
  return (
    <html lang="es" className="bg-gray-200 dark:bg-gray-900 dark:text-white h-[100dvh]" suppressHydrationWarning>
      <body className={`${geistSans.variable} ${mont.className} antialiased dark:bg-gray-900 dark:text-white`}>
        <Providers>
